...
with open("jour03/job01/data.txt", "r") as file:
    ...
    for line in file:
        ...
        for i in range(len(line) - 1):
            ...
            # Vérifier que les caractères sont des lettres de l'alphabet anglais
            if current_letter in string.ascii_lowercase and next_letter in string.ascii_lowercase:
